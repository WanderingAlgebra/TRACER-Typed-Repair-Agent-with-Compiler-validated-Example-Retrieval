...
项目背景与活动信息见 [SJTU AI4Math Summer School 2026](https://sjtu-ai4math.github.io/summer-school/2026/)。实验范围及结论限制见下文，不将上述数量视为通用证明能力或性能领先的证据。
...
公开案例各自记录来源许可；当前仓库尚未提供仓库级 `LICENSE` 文件，**不要把案例许可理解为整仓授权**。需要再分发或其他用途授权时，请先与维护者确认。
