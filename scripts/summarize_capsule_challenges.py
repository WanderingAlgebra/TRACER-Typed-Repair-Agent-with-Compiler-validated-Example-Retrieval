...
def render_report(payload: dict[str, Any], cases: list[dict[str, Any]]) -> str:
    ...
    if replay_failures:
        ...
        priority = (
            "The first priority is dependency-aware extraction because fallback was required for "
    ...
    return "\n".join(
        [
            ...
            "It is separate from the public core gallery and its release audit: fallback, diagnostic drift, and replay failure are valid challenge outcomes rather than CI release failures.",
            "",
